...
const Profile = ({ profileName,profileEmail }: { profileName: string,profileEmail: string}) => {
  const [isEditing, setIsEditing] = useState(false);
  const [isDeleteModalOpen, setIsDeleteModalOpen] = useState(false);
  const [formData, setFormData] = useState({
    name: profileName || "John Doe",
    email: profileEmail || "john@example.com",
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-8">
              ...
              <div className="border-2 border-destructive p-6">
                ...
                <Button variant="destructive" size="sm" type="button" onClick={() => setIsDeleteModalOpen(true)}>
                  Delete Account
                </Button>
